Раздел содержит общую информацию об всем, что есть вокруг Evolution CE и что вам необходимо знать перед началом работы с системой.
...
2.  **Уровень логики (Контроллер):** Логику страниц можно описывать в классах-контроллерах (подход Laravel) или по-старинке — в сниппетах. Выбор за вами.
...
---
*- Информация актуальна для всех версий Evolution CE, но орентирована на версию 1.4.х