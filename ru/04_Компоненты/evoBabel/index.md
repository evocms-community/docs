...
Страница 404
---------
Для того чтобы 404 страница работала правильно нужно в корневой папке для основного языка создать ресурс, его ID прописать в настройках сайта (самая первая вкладка, в поле Страница ошибки '404' [(error_page)]). Далее для этого ресурса нужно создать связи в других языках. Далее зайти в модуль с лексиконами и там внести параметр с именем "Страница не найдена". В колонки с языками нужно вписать ID ресурса созданных "404 страниц" для каждого языка.
<img width="966" height="71" alt="image" src="https://github.com/user-attachments/assets/2178be4e-7800-42a1-abf2-1236f8610771" />
